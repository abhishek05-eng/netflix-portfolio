        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Abhishek Sabarad</span>, a Computer Science Engineering graduate from New Horizon College of Engineering, Bengaluru.
              </p>
            ...
            <div className="space-y-5 relative z-10">
              ...
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>Pitched and demonstrated project solutions to judges at the <strong className="text-white">Flipkart Grid Hackathon</strong>.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Published a peer-reviewed research paper on a <strong className="text-white">Smart Agriculture System</strong> for greenhouse management.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Certified in <strong className="text-white">AI & Uses</strong> (Be10x) and <strong className="text-white">Journey to Cloud</strong> (IBM SkillsBuild).</span>
                </li>
              </ul>
            </div>
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['Python', 'Java', 'Flask', 'Django', 'MySQL', 'Git & GitHub', 'Figma'].map((tech, idx) => (
                <span
                  key={idx}
